...
const todayDate = format(actualDate, dateFormat);
...
export default function AddIncome({ show, onHide, mutate, selected, lookup }: AddIncome) {
	...
	return (
		<Modal someRef={inputRef} show={show} title={`${selected.id ? 'Editar' : 'Adicionar'} Receita`} onHide={onHide}>
