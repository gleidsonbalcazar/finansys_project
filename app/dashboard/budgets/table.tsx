...
import { BudgetData, deleteBudget } from './apis';
...
export default function BudgetTable() {
	...
	const onEdit = useCallback(async (data: BudgetData | any) => {
		setSelected(data);
	}, []);
	...
	return (
		...
		<>
			<DataTable
				...
				filename="orcamento"
			/>
			<Add onHide={onHide} onLookup={onLookup} selected={selected} mutate={mutate} type="budget" />
		</>
	);
}
