...
import { InvestmentsData, deleteInvestments, executeInvestments } from './apis';
...
export default function InvestmentsTable() {
	...
	const onEdit = useCallback(async (data: InvestmentsData | any) => {
		setSelected(data);
	}, []);
